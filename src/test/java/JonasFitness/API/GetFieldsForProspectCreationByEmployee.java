...
//						.log().body()
						...
						.body("Result[7].Required", equalTo(false))
						...
						.body("Result[8].Required", equalTo(false))
...
//						.log().body()
						...
						.body("Result[55].Values[0].Id", equalTo(2))
						.body("Result[55].Values[0].Value", equalTo("Prospect"))
						.body("Result[55].Values[1].Id", equalTo(11))
						.body("Result[55].Values[1].Value", equalTo("Non-Member Child"))
						...
						.body("Result[63].FieldName", equalTo("StageId"))
						.body("Result[63].Description", equalTo("Stage"))
						.body("Result[63].DisplayValue", equalTo("Stage"))
						...
						.body("Result[64].FieldName", equalTo("Priority"))
						.body("Result[64].Description", equalTo("Priority"))
						.body("Result[64].DisplayValue", equalTo("Priority"))
						.body("Result[64].Required", equalTo(false))
						.body("Result[64].ValueMustBeInDefinedList", equalTo(true))
						.body("Result[64].Values[0].Id", equalTo(1))
						.body("Result[64].Values[0].Value", equalTo("Drive By"))
						.body("Result[64].Values[1].Id", equalTo(2))
						.body("Result[64].Values[1].Value", equalTo("Onsite Search"))
						.body("Result[64].Values[2].Id", equalTo(3))
						.body("Result[64].Values[2].Value", equalTo("Friend"))
						.body("Result[64].Values[3].Id", equalTo(4))
						.body("Result[64].Values[3].Value", equalTo("Newspaper"))
						.body("Result[64].Values[4].Id", equalTo(5))
						.body("Result[64].Values[4].Value", equalTo("Social Media"))
						.body("Result[64].Values[5].Id", equalTo(6))
						.body("Result[64].Values[5].Value", equalTo("Community Event"))
						.body("Result[64].Values[6].Id", equalTo(7))
						.body("Result[64].Values[6].Value", equalTo("Other"))
						
						.body("Result[65].FieldName", equalTo("SalespersonID"))
						.body("Result[65].Description", equalTo("Salesperson"))
						.body("Result[65].DisplayValue", equalTo("Salesperson"))
						.body("Result[65].Required", equalTo(false))
						...
						.body("Result[66].FieldName", equalTo("MedicalNote"))
						.body("Result[66].Description", equalTo("Medical Note"))
						.body("Result[66].DisplayValue", equalTo("Medical Note"))
						.body("Result[66].Required", equalTo(false))
						.body("Result[66].ValueMustBeInDefinedList", equalTo(true))
						.body("Result[66]", hasKey("Values"))
						.body("Result[66].MaximumLength", equalTo(60))
						.body("Result[66].DataType", equalTo("string"))
						
						.body("Result[67].FieldName", equalTo("BarcodeID"))
						.body("Result[67].Description", equalTo("Member Id"))
						.body("Result[67].DisplayValue", equalTo("Member Id"))
						.body("Result[67].Required", equalTo(true))
						.body("Result[67].ValueMustBeInDefinedList", equalTo(false))
						.body("Result[67]", hasKey("Values"))
						.body("Result[67].MaximumLength", equalTo(0))
						.body("Result[67].DataType", equalTo("string"))
						;
	}
}
