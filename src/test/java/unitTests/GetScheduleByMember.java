...
//						.log().body()
	...
	@Test (testName="Training Found",description="PBI:124954")
	public void trainingFound() {

				String c = prop.getProperty("appointmentId");
				int customerId = Integer.parseInt(c);
				String sDateTimeNoOffset = "2025-03-27";
...
//						.log().body()
						...
						.body("Result[1]", hasKey( "CanCancel"))
						.body("Result[1]", hasKey("CanChange"))
						...
						.body("Result[2]", hasKey( "CanCancel"))
						.body("Result[2]", hasKey("CanChange"))
						...
						.body("Result[3]", hasKey( "CanCancel"))
						.body("Result[3]", hasKey("CanChange"))
