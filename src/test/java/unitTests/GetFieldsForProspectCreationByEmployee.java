...
//						.log().body()
						...
						/* .body("Result.FieldName", anyOf(hasItem("StageId")))
						.body("Result.Description", anyOf(hasItem("Stage")))
						.body("Result.DisplayValue", anyOf(hasItem("Stage")))
						.body("Result.Required", anyOf(hasItem(false)))
						.body("Result.ValueMustBeInDefinedList", anyOf(hasItem(false)))
						.body("Result.MaximumLength", anyOf(hasItem(0)))
						.body("Result.DataType", anyOf(hasItem("string"))) */
						
						.body("Result.FieldName", anyOf(hasItem("Priority")))
						.body("Result.Description", anyOf(hasItem("Priority")))
						.body("Result.DisplayValue", anyOf(hasItem("Priority")))
						.body("Result.Required", anyOf(hasItem(false)))
						.body("Result.ValueMustBeInDefinedList", anyOf(hasItem(true)))
						.body("Result.MaximumLength", anyOf(hasItem(0)))
						.body("Result.DataType", anyOf(hasItem("string")))
